...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skins2024/main/Mx-SunMoon-fhd-posterX_modHA.tar.gz"
wait
tar -xzf Mx-SunMoon-fhd-posterX_modHA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/Mx-SunMoon-fhd-posterX_modHA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
