...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skins2024/main/oDreamyFHD_mini-posterX-Mod_HA.tar.gz"
wait
tar -xzf oDreamyFHD_mini-posterX-Mod_HA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/oDreamyFHD_mini-posterX-Mod_HA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
