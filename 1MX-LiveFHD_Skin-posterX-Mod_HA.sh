...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skins2024/main/MX-LiveFHD-posterX_modHA.tar.gz"
wait
tar -xzf MX-LiveFHD-posterX_modHA.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/MX-LiveFHD-posterX_modHA.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
