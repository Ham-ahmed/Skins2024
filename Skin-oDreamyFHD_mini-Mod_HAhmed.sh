...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skins2024/main/oDreamyFHD-mini_Mod-HAhmed.tar.gz"
wait
tar -xzf oDreamyFHD-mini_Mod-HAhmed.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/oDreamyFHD-mini_Mod-HAhmed.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
