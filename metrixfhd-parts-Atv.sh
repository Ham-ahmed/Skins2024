...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skins2024/main/metrixfhd-parts-atv.tar.gz"
wait
tar -xzf metrixfhd-parts-atv.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/metrixfhd-parts-atv.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
