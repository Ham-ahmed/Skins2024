...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skins2024/main/YouViX-Skin_PosterX_4x1-Mod-HAhmed.tar.gz"
wait
tar -xzf YouViX-Skin_PosterX_4x1-Mod-HAhmed.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/YouViX-Skin_PosterX_4x1-Mod-HAhmed.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
